...
/***/ function(module, exports, __webpack_require__) {
	...
	var uploadEvents = __webpack_require__(30);
	var modalEvents = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var logInViewState = function logInViewState() {
	  $('.hamburger').hide();
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(signUpData).then(function (data) {
	    return api.signIn(signUpData);
	  }).then(function (data) {
	    return ui.onSignInSuccess(data);
	  }).then(api.getAllUsers).then(function (data) {
	    return ui.sidebarSuccess(data);
	  }).catch(function (error) {
	    return ui.onSignUpError(error);
	  });
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(function (data) {
	    return ui.onSignInSuccess(data);
	  }).then(api.getAllUsers).then(function (data) {
	    return ui.sidebarSuccess(data);
	  }).catch(function (error) {
	    return ui.onSignInError(error);
	  });
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).then(function (data) {
	    return ui.onChangePasswordSuccess(data);
	  }).catch(function (error) {
	    return ui.onChangePasswordError(error);
	  });
	};
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().then(function (data) {
	    return ui.signOutSuccess(data);
	  }).catch(function (error) {
	    return ui.onError(error);
	  });
	};
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://desert-island-api.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var displayImageThumbnails = __webpack_require__(8);
	var displayNameHeader = __webpack_require__(28);
	var populateSidebar = __webpack_require__(29);
	...
	var sidebarSuccess = function sidebarSuccess(data) {
	...
	var sidebarFailure = function sidebarFailure(error) {
	  console.error(error);
	};
	...
	module.exports = {
	  ...
	  onError: onError,
	  sidebarSuccess: sidebarSuccess,
	  sidebarFailure: sidebarFailure,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"col-xs-2\">\n  <div class=\"thumbnail\">\n    <a href = "
	    ...
	    + "\">\n        <i class=\"fa fa-trash-o fa-lg\"></i> DELETE\n      </button>\n      <i class=\"fa fa-pencil-square edit-button fa-2x\" aria-hidden=\"true\" id=\""
	    + alias2(alias1((depth0 != null ? depth0._id : depth0), depth0))
	    + "\"></i>\n    </div>\n  </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.uploads : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return container.escapeExpression(((helper = (helper = helpers.userName || (depth0 != null ? depth0.userName : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"userName","hash":{},"data":data}) : helper)))
	    + "'s Desert Island\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.isOwner : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data) {
	    var alias1=container.lambda, alias2=container.escapeExpression;

	  return "    <li class='user-link' style=\"background:red\">\n      <a href=\"#\" id=\""
	    + alias2(alias1((depth0 != null ? depth0._id : depth0), depth0))
	    + "\">"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateUpload = function onCreateUpload(event) {
	  ...
	  api.createUpload(data).then(function (data) {
	    return ui.onCreateUploadSuccess(data);
	  }).catch(function (error) {
	    return ui.onCreateUploadFailure(error);
	  });
	};
	...
	var onDeleteUpload = function onDeleteUpload(event) {
	  ...
	  api.deleteUpload(id).then(api.getUser).then(function (data) {
	    return ui.updateUserSuccess(data);
	  }).then(ui.onDeleteUploadSuccess).catch(function (error) {
	    return ui.onDeleteUploadFailure(error);
	  });
	};

	var onEditUpload = function onEditUpload(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var imageId = $(event.target).attr('class');
	  api.editUpload(data, imageId).then(api.getUser).then(function (data) {
	    return ui.updateUserSuccess(data);
	  }).then(ui.onThumbnailUpdateSuccess).catch(function (error) {
	    return ui.onEditUploadError(error);
	  });
	};

	var viewUserIsland = function viewUserIsland(event) {
	  event.preventDefault();

	  var id = event.target.id;

	  var isOwner = id === app.user._id;
	  ...
	  if (isOwner) {
	    ...
	    api.getOtherUser(id).then(function (data) {
	      return ui.updateOtherUserSuccess(data);
	    }).then(ui.onUpdateOtherUserThumbnailSuccess).catch(function (error) {
	      return ui.onError(error);
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createUpload = function createUpload(data) {
	  return new Promise(function (resolve, reject) {
	    return $.ajax({
	...
	var editUpload = function editUpload(data, imageId) {
	  return new Promise(function (resolve, reject) {
	    return $.ajax({
	...
	var getOtherUser = function getOtherUser(id) {
	  return new Promise(function (resolve, reject) {
	    return $.ajax({
	      url: app.host + "/users/" + id,
	      method: 'GET',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var displayImageThumbnails = __webpack_require__(8);
	var otherUserThumbnailUpdate = __webpack_require__(33);
	var displayNameHeader = __webpack_require__(28);
	...
	var onCreateUploadSuccess = function onCreateUploadSuccess(data) {
	  var newUpload = data.upload;
	...
	var onCreateUploadFailure = function onCreateUploadFailure() {
	  $('#upload-error').show();
	};
	...
	var updateOtherUserSuccess = function updateOtherUserSuccess(data) {
	  app.otherUser = data.user;
	  $('header h1').html(displayNameHeader(app.otherUser));
	  $('#upload-button').hide();
	};

	var updateUserFailure = function updateUserFailure(error) {
	  console.error(error);
	};
	...
	var onDeleteUploadFailure = function onDeleteUploadFailure(error) {
	  console.error(error);
	};

	var onThumbnailUpdateSuccess = function onThumbnailUpdateSuccess() {
	  $('#images-display-box .row').html(displayImageThumbnails(app.user));
	  $('#editModal').modal('hide');
	};

	var onUpdateOtherUserThumbnailSuccess = function onUpdateOtherUserThumbnailSuccess() {
	...
	module.exports = {
	  ...
	  onCreateUploadSuccess: onCreateUploadSuccess,
	  onCreateUploadFailure: onCreateUploadFailure,
	  ...
	  onThumbnailUpdateSuccess: onThumbnailUpdateSuccess,
	  updateOtherUserSuccess: updateOtherUserSuccess,
	  onUpdateOtherUserThumbnailSuccess: onUpdateOtherUserThumbnailSuccess,
	  onError: onError
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var editImageModal = function editImageModal() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "e2f2a78ff7e9147f35b2f8b2cce74dc3.jpg";
